...
public:
	DipoleEwald3D()
		...
		nSites(10), d1(8), d2(8), d3(8) //sane default values
	{
		//cubic unit cell
	...
	// a,b: X=0, Y=1, Z=2
	bool calcTensorElement(const int alpha, const int beta, const int* r3, double& element, double tau);
	
	void setUnitCell(const vector<double>& A1, const vector<double>& A2, const vector<double>& A3);
	...
	int setNSites(int n) {nSites = n; gotGoodEta = false;}
