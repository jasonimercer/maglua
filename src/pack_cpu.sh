...
cp configure build_cpu.sh build_cmake.sh libMagLua.h libMagLua.cpp hardcode.lua bootstrap.lua shutdown.lua COPYRIGHT modules.h modules.cpp loader.cpp loader.h import.h main.cpp makefile.common.cpu makefile.common.mpi makefile.common.lua dofile.lua help.lua os_extensions.cpp os_extensions.h README main.h xerbla.cpp xerbla.h $version
make distclean
